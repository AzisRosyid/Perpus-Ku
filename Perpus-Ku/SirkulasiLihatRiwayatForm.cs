...
namespace Perpus_Ku
{
    public partial class SirkulasiLihatRiwayatForm : Form
    {
        public SirkulasiLihatRiwayatForm()
        {
            InitializeComponent();
        }
        ...
        private void SirkulasiLihatRiwayatForm_Load(object sender, EventArgs e)
        {
