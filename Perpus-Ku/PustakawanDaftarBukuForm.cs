...
namespace Perpus_Ku
{
    public partial class PustakawanDaftarBukuForm : Form
    {
        public PustakawanDaftarBukuForm()
        {
            InitializeComponent();
        }
        ...
        private void PustakawanDaftarBukuForm_Load(object sender, EventArgs e)
        {
        ...
        {
            PustakawanUbahBukuForm fr = new PustakawanUbahBukuForm();
            PustakawanUbahBukuForm.id = dataGridView1.CurrentRow.Cells["ISBN"].Value.ToString();
            fr.FormClosed += Fr_FormClosed1;
            Method.form(fr, this);
        }
